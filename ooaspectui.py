...
if __name__ == '__main__':
    ...
    exclusive_input_group.add_argument("-D", "--dumpfile", type=str, help="A file generated by the ASPECT dump utility. Each line of this file contains the name of a fits file. The number of lines has to be the square of an integer which corresponds to the map's edge length - 1.")
