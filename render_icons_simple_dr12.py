...
def fits_to_files ( filename, icon_size, icon_style, output_base_dir):
    ...
    try:
        ...
        data_fields = ['ra', 'dec', 'mjd', 'radeg', 'decdeg', 'plateid', 'name', 'fiberid']
        data = dict()
        value_string = ""
        ...
        spectrum=fits_file[1].data['flux']
        ...
        if not os.path.exists(output_filename):
            ...
            if icon_style == 'nice':
                ...
                plt.axis('off')
                plt.plot(downsized_spectrum, antialiased = True, linewidth=2.0, color='black')
