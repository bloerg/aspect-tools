...
if __name__ == '__main__':
    ...
    parser.add_argument("-i", "--inputdir", type=str, required=True, help="Directory containing plate folders with fits.png files, i. e. the spec icons computed by ASPECT. Can have sub directories.")
    parser.add_argument("-o", "--outputdir", type=str, required=True, help="Output directory for plotted spectra icons.")
    parser.add_argument("-H", "--htmlfile", type=str, required=True, help="A file similar to full0_0.html in the export directory of the ASPECT output.")
    ...
    icon_size = (args.iconsize + 4, args.iconsize + 4)
    ...
    print("Trying to parse html file.\n")
    ##try to read html input file
    ...
    print("Writing idmapping files, spectra metadata files and hightest zoom level spectra icons.\n")
    ...
    for row in tr:
        ...
        for cell in row.find_all('td'):
            ...
            if os.path.exists(image_file_path):
                ...
                temp_icon.paste(source_icon.resize((icon_size[0]-4, icon_size[1] - 4)), (2, 2))
    ...
    print("creating directory structure for lower zoom level spectra icons\n")
